...
@interface ImageTargetsViewController : UIViewController <SampleApplicationControl, SampleAppMenuDelegate, ImageTargetsEAGLViewDelegate> {
    
    Vuforia::DataSet*  dataSetCurrent;
    Vuforia::DataSet*  dataSetTarmac;
    Vuforia::DataSet*  dataSetStonesAndChips;
    Vuforia::DataSet*  dataSetStonesAndChips1;
...
@property (nonatomic, strong) NSString *trackableName;
